...
public class RegressionTest {
	...
	private static void simple() {
		// TODO Auto-generated method stub
		double[][] data = { { 0.1, 0.2 }, { 338.8, 337.4 }, { 118.1, 118.2 }, { 888.0, 884.6 }, { 9.2, 10.1 },
				{ 228.1, 226.5 }, { 668.5, 666.3 }, { 998.5, 996.3 }, { 449.1, 448.6 }, { 778.9, 777.0 },
				{ 559.2, 558.2 }, { 0.3, 0.4 }, { 0.1, 0.6 }, { 778.1, 775.5 }, { 668.8, 666.9 }, { 339.3, 338.0 },
				{ 448.9, 447.5 }, { 10.8, 11.6 }, { 557.7, 556.0 }, { 228.3, 228.1 }, { 998.0, 995.8 },
				{ 888.8, 887.6 }, { 119.6, 120.2 }, { 0.3, 0.3 }, { 0.6, 0.3 }, { 557.6, 556.8 }, { 339.3, 339.1 },
				{ 888.0, 887.2 }, { 998.5, 999.0 }, { 778.9, 779.0 }, { 10.2, 11.1 }, { 117.6, 118.3 },
	...
	private static void regression() {
		...
		for(int i=0;i<count;i++) {
			double zbl = (Math.random())*100;
			double zbl2 = (Math.random())*100;
			x[i] = new double[] {zbl,(zbl)*(zbl),Math.pow((zbl), -0.5),zbl2};
			y[i] = Math.pow(x[i][0],-0.5)+zbl2+1+(Math.random()-0.5)*/*Math.pow(x[i][0],2)**/0.05;
			System.out.println(y[i]);
		}
//		x[0] = new double[] { 2.0,4, 1/*, 0, 0, 0, 0*/ };
//		x[1] = new double[] { 4.0,16, 2.0/*, 0, 0, 0, 0*/ };
//		x[2] = new double[] { 6.0,36, 3/*, 3.0, 0, 0, 0 */};
//		x[3] = new double[] { 2.0,4, 3/*, 0, 4.0, 0, 0*/ };
//		x[4] = new double[] { 4.0,16, 2/*, 0, 0, 5.0, 0 */};
//		x[5] = new double[] { 6.0,36, 1/*, 0, 0, 0, 6.0*/ };
		...
		double[][] param = regression.estimateRegressionParametersVariance();
